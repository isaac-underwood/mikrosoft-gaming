...
class FixSortGamesByScores extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        g.id, g.title, g.body, g.created_at, g.updated_at, Count(h.game_id) AS scoreCount
        FROM games g JOIN highscores h
        ON g.id = h.game_id
        GROUP BY g.title
        UNION
        SELECT DISTINCT
        g2.id, g2.title, g2.body, g2.created_at, g2.updated_at, Count(h2.game_id) AS scoreCount
